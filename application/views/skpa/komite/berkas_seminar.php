								...
								<tbody>
									...
									?>
										...
										<tr>
											...
											<td><?= $row['nama_judul'] ?>
												<?php if ($row['is_acc_2_1'] == '0') {
													echo "<br><small>Ket : " . $row['ket_tolak'] . "</small>";
												} ?>
											</td>
											<td class="text-center">
												<?php if ($row['file_seminar'] != '' && !$row['is_backed_up']) { ?>
													<a href="<?= base_url('assets/file/seminar/' . $row['file_seminar']) ?>" class='btn btn-outline-info btn-sm'><i class='fa fa-file'></i></a>
												<?php } else { ?>
													<span class='badge badge-warning'>Berkas telah dibackup</span>
												<?php } ?>
											</td>
											<td class="text-center">
												<?php
												if ($row['is_acc_2_1'] == '-1') {
													if ($row['is_berkas_seminar_upload'] == '0') {
														...
														<a data-toggle="tooltip" title="Terima" onclick="konfirmasi(
